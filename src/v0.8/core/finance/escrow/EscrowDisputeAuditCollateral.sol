...
/// @title EscrowDisputeAuditCollateral
/// @dev This contract provides functions for managing EscrowDisputeAuditCollateral-related operations.
contract EscrowDisputeAuditCollateral is EscrowBase {
    /// @notice Get dataset EscrowDisputeAuditCollateral requirement.
