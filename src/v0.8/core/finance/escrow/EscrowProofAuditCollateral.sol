...
/// @title EscrowProofAuditCollateral
/// @dev This contract provides functions for managing EscrowProofAuditCollateral-related operations.
contract EscrowProofAuditCollateral is EscrowBase {
    /// @notice Get dataset EscrowProofAuditCollateral requirement.
        ...
        returns (uint256 amount)
    {
        (, , uint256 current, ) = roles.finance().getAccountEscrow(
            ...
            _payer,
            _token,
            FinanceType.Type.EscrowProofAuditCollateral
        );

        amount = roles.filplus().finaceRuleDatasetProofCollateral();
    ...
    function _getPayers(
        ...
        owners[0] = roles.datasetsProof().getDatasetProofSubmitter(_datasetId);
    }
