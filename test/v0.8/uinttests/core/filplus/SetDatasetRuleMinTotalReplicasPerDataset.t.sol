...
import {SetDatasetRuleMinTotalReplicasPerDatasetTestCaseWithSuccess, SetDatasetRuleMinTotalReplicasPerDatasetTestCaseWithInvalidGovernancer} from "test/v0.8/testcases/core/filplus/SetDatasetRuleMinTotalReplicasPerDatasetTestSuite.sol";
import {FilplusTestSetup} from "test/v0.8/uinttests/core/filplus/setup/FilplusTestSetup.sol";

contract SetDatasetRuleMinTotalReplicasPerDatasetTest is
    Test,
    FilplusTestSetup
{
    /// @notice test case with success
    function testSetDatasetRuleMinTotalReplicasPerDatasetWithSuccess(
        uint16 _newValue
    ) public {
        setup();
    ...
    function testSetDatasetRuleMinTotalReplicasPerDatasetWithInvalidGovernancer(
        uint16 _newValue
    ) public {
        setup();
