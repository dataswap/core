...
import {SetDatasetRuleMaxReplicasPerCityTestCaseWithSuccess, SetDatasetRuleMaxReplicasPerCityTestCaseWithInvalidGovernancer} from "test/v0.8/testcases/core/filplus/SetDatasetRuleMaxReplicasPerCityTestSuite.sol";
import {FilplusTestSetup} from "test/v0.8/uinttests/core/filplus/setup/FilplusTestSetup.sol";

contract SetDatasetRuleMaxReplicasPerCityTest is Test, FilplusTestSetup {
    /// @notice test case with success
    function testSetDatasetRuleMaxReplicasPerCityWithSuccess(
        uint16 _newValue
    ) public {
        setup();
    ...
    function testSetDatasetRuleMaxReplicasPerCityWithInvalidGovernancer(
        uint16 _newValue
    ) public {
        setup();
