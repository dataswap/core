...
import {SetDatasetRuleMinSPsPerDatasetTestCaseWithSuccess, SetDatasetRuleMinSPsPerDatasetTestCaseWithInvalidGovernancer} from "test/v0.8/testcases/core/filplus/SetDatasetRuleMinSPsPerDatasetTestSuite.sol";
import {FilplusTestSetup} from "test/v0.8/uinttests/core/filplus/setup/FilplusTestSetup.sol";

contract SetDatasetRuleMinSPsPerDatasetTest is Test, FilplusTestSetup {
    /// @notice test case with success
    function testSetDatasetRuleMinSPsPerDatasetWithSuccess(
        uint16 _newValue
    ) public {
        setup();
    ...
    function testSetDatasetRuleMinSPsPerDatasetWithInvalidGovernancer(
        uint16 _newValue
    ) public {
        setup();
