...
import {SetDatasetRuleMaxProportionOfMappingFilesToDatasetTestCaseWithSuccess, SetDatasetRuleMaxProportionOfMappingFilesToDatasetTestCaseWithInvalidGovernancer} from "test/v0.8/testcases/core/filplus/SetDatasetRuleMaxProportionOfMappingFilesToDatasetTestSuite.sol";
import {FilplusTestSetup} from "test/v0.8/uinttests/core/filplus/setup/FilplusTestSetup.sol";

contract SetDatasetRuleMaxProportionOfMappingFilesToDatasetTest is
    Test,
    FilplusTestSetup
{
    /// @notice test case with success
    function testSetDatasetRuleMaxProportionOfMappingFilesToDatasetWithSuccess(
        uint8 _newValue
    ) public {
        setup();
    ...
    function testSetDatasetRuleMaxProportionOfMappingFilesToDatasetWithInvalidGovernancer(
        uint8 _newValue
    ) public {
        setup();
