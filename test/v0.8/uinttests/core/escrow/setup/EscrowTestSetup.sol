...
contract EscrowTestSetup is BaseTestSetup {
    EscrowAssertion assertion;
    MatchingsHelpers matchingsHelpers;
    StoragesHelpers storagesHelpers;
    ...
    function setup() internal {
        ...
        matchingsHelpers = new MatchingsHelpers(
            carstore,
            datasets,
            datasetsProof,
            matchings,
