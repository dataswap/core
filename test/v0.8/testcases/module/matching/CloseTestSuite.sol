...
import {CloseTestSuiteBase} from "test/v0.8/testcases/module/matching/abstract/MatchingsTestSuiteBase.sol";
...
contract CloseTestCaseWithSuccess is CloseTestSuiteBase {
    constructor(
        IMatchings _matchings,
        IMatchingsHelpers _matchingsHelpers,
        IMatchingsAssertion _matchingsAssertion
    )
        CloseTestSuiteBase(_matchings, _matchingsHelpers, _matchingsAssertion) // solhint-disable-next-line
    {}
    ...
    function before(uint64 _matchingId) internal virtual override {
        ...
        vm.roll(101);
        vm.prank(address(99));
        matchings.bidding(_matchingId, 200);
    }
    ...
    function action(
        ...
        super.action(_matchingId, address(99));
    }
}
