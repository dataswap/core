...
///@notice reject metadata of dataset test caset with success.
contract RejectMetadataTestCaseWithSuccess is DatasetsTestBase {
    constructor(
        IDatasets _datasets,
...
///@notice reject metadata of dataset test caset with invalid address.
contract RejectMetadataTestCaseWithInvalidAddress is DatasetsTestBase {
    constructor(
        IDatasets _datasets,
        IDatasetsHelpers _datasetsHelpers,
        IDatasetsAssertion _datasetsAssertion
    ...
    function action(uint64 _id) internal virtual override {
        ...
        datasetsAssertion.rejectDatasetMetadataAssertion(address(8), _id);
    }
}

///@notice reject metadata of dataset test caset with zero dataset id.
contract RejectMetadataTestCaseWithZeroID is DatasetsTestBase {
    constructor(
        IDatasets _datasets,
        IDatasetsHelpers _datasetsHelpers,
        IDatasetsAssertion _datasetsAssertion
    ...
    function action(uint64) internal virtual override {
        ...
        datasets.rejectDatasetMetadata(0);
    }
}

///@notice reject metadata of dataset test caset with invalid state.
contract RejectMetadataTestCaseWithInvalidState is DatasetsTestBase {
    constructor(
        IDatasets _datasets,
        IDatasetsHelpers _datasetsHelpers,
        IDatasetsAssertion _datasetsAssertion
