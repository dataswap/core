...
/// @notice set datasetRuleDefaultMaxReplicasPerCountry test case,it should be success
contract SetDatasetRuleDefaultMaxReplicasPerCountryTestCaseWithSuccess is
    SetVariableOfUint16TestSuiteBase
{
    ...
    function action(uint16 _newValue) internal virtual override {
        ...
        assertion.setDatasetRuleDefaultMaxReplicasPerCountryAssertion(
...
/// @notice set datasetRuleDefaultMaxReplicasPerCountry test case with invalid governancer,it should be capture revert
contract SetDatasetRuleDefaultMaxReplicasPerCountryTestCaseWithInvalidGovernancer is
    SetVariableOfUint16TestSuiteBase
{
    constructor(
        IFilplus _filplus,
