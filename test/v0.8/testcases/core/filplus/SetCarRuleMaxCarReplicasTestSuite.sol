...
/// @notice set carRuleMaxCarReplicas test case,it should be success
contract SetCarRuleMaxCarReplicasTestCaseWithSuccess is
    SetVariableOfUint16TestSuiteBase
{
    ...
    function action(uint16 _newValue) internal virtual override {
        ...
        assertion.setCarRuleMaxCarReplicasAssertion(
...
/// @notice set carRuleMaxCarReplicas test case with invalid governancer,it should be capture revert
contract SetCarRuleMaxCarReplicasTestCaseWithInvalidGovernancer is
    SetVariableOfUint16TestSuiteBase
{
    constructor(
        IFilplus _filplus,
    ...
    function action(uint16 _newValue) internal virtual override {
        ...
        assertion.setCarRuleMaxCarReplicasAssertion(addr, _newValue);
    }
}
