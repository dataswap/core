...
/// @notice set datasetRuleMinSPsPerDataset test case,it should be success
contract SetDatasetRuleMinSPsPerDatasetTestCaseWithSuccess is
    SetVariableOfUint16TestSuiteBase
{
    ...
    function action(uint16 _newValue) internal virtual override {
        ...
        assertion.setDatasetRuleMinSPsPerDatasetAssertion(
...
/// @notice set datasetRuleMinSPsPerDataset test case with invalid governancer,it should be capture revert
contract SetDatasetRuleMinSPsPerDatasetTestCaseWithInvalidGovernancer is
    SetVariableOfUint16TestSuiteBase
{
    constructor(
        IFilplus _filplus,
    ...
    function action(uint16 _newValue) internal virtual override {
        ...
        assertion.setDatasetRuleMinSPsPerDatasetAssertion(addr, _newValue);
    }
}
