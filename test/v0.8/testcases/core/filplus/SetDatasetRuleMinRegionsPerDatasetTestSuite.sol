...
/// @notice set datasetRuleMinRegionsPerDataset test case,it should be success
contract SetDatasetRuleMinRegionsPerDatasetTestCaseWithSuccess is
    SetVariableOfUint16TestSuiteBase
{
    ...
    function action(uint16 _newValue) internal virtual override {
        ...
        assertion.setDatasetRuleMinRegionsPerDatasetAssertion(
...
/// @notice set datasetRuleMinRegionsPerDataset test case with invalid governancer,it should be capture revert
contract SetDatasetRuleMinRegionsPerDatasetTestCaseWithInvalidGovernancer is
    SetVariableOfUint16TestSuiteBase
{
    constructor(
        IFilplus _filplus,
    ...
    function action(uint16 _newValue) internal virtual override {
        ...
        assertion.setDatasetRuleMinRegionsPerDatasetAssertion(addr, _newValue);
    }
}
