...
/// @notice set datasetRuleMaxReplicasPerSP test case,it should be success
contract SetDatasetRuleMaxReplicasPerSPTestCaseWithSuccess is
    SetVariableOfUint16TestSuiteBase
{
    ...
    function action(uint16 _newValue) internal virtual override {
        ...
        assertion.setDatasetRuleMaxReplicasPerSPAssertion(
...
/// @notice set datasetRuleMaxReplicasPerSP test case with invalid governancer,it should be capture revert
contract SetDatasetRuleMaxReplicasPerSPTestCaseWithInvalidGovernancer is
    SetVariableOfUint16TestSuiteBase
{
    constructor(
        IFilplus _filplus,
    ...
    function action(uint16 _newValue) internal virtual override {
        ...
        assertion.setDatasetRuleMaxReplicasPerSPAssertion(addr, _newValue);
    }
}
