...
/// @notice set matchingRulesDataswapCommissionPercentage test case,it should be success
contract SetMatchingRulesDataswapCommissionPercentageTestCaseWithSuccess is
    SetVariableOfUint8TestSuiteBase
{
    ...
    function action(uint8 _newValue) internal virtual override {
        ...
        assertion.setMatchingRulesDataswapCommissionPercentageAssertion(
...
/// @notice set matchingRulesDataswapCommissionPercentage test case with invalid governancer,it should be capture revert
contract SetMatchingRulesDataswapCommissionPercentageTestCaseWithInvalidGovernancer is
    SetVariableOfUint8TestSuiteBase
{
    constructor(
        IFilplus _filplus,
