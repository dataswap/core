...
/// @notice set datasetRuleMinTotalReplicasPerDataset test case,it should be success
contract SetDatasetRuleMinTotalReplicasPerDatasetTestCaseWithSuccess is
    SetVariableOfUint16TestSuiteBase
{
    ...
    function action(uint16 _newValue) internal virtual override {
        ...
        assertion.setDatasetRuleMinTotalReplicasPerDatasetAssertion(
...
/// @notice set datasetRuleMinTotalReplicasPerDataset test case with invalid governancer,it should be capture revert
contract SetDatasetRuleMinTotalReplicasPerDatasetTestCaseWithInvalidGovernancer is
    SetVariableOfUint16TestSuiteBase
{
    constructor(
        IFilplus _filplus,
