...
/// @notice set datasetRuleMaxTotalReplicasPerDataset test case,it should be success
contract SetDatasetRuleMaxTotalReplicasPerDatasetTestCaseWithSuccess is
    SetVariableOfUint16TestSuiteBase
{
    ...
    function action(uint16 _newValue) internal virtual override {
        ...
        assertion.setDatasetRuleMaxTotalReplicasPerDatasetAssertion(
...
/// @notice set datasetRuleMaxTotalReplicasPerDataset test case with invalid governancer,it should be capture revert
contract SetDatasetRuleMaxTotalReplicasPerDatasetTestCaseWithInvalidGovernancer is
    SetVariableOfUint16TestSuiteBase
{
    constructor(
        IFilplus _filplus,
